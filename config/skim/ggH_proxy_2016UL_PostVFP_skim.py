...
cfg =  {
    "dataset" : {
        "jsons": ["datasets/MC_GluGluH_RunIISummer20UL_local.json"],
        "filter" : {
            "samples": samples,
            "samples_exclude" : [],
            "year": ['2016_PostVFP']
    ...
    "output"   : "output/pocket_coffea/ggHcc_proxy/ggHcc_proxy_2016UL_PostVFP_skim",
    "workflow_options" : {},
    ...
    "save_skimmed_files": 'root://t3dcachedb03.psi.ch:1094//pnfs/psi.ch/cms/trivcat/store/user/mmarcheg/BTVNanoCommissioning/skim/skim_2016_PostVFP/',
